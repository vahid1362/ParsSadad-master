...
namespace QtasHelpDesk.CrossCutting.IdentityToolkit
{
    /// <summary>
    ...
    public static class IdentityExtensions
    {
        ...
        public static string GetUserClaimValue(this IIdentity identity, string claimType)
        {
            ...
            var result= identity1?.FindFirstValue(claimType);
            return result;
        }
        ...
        public static string GetPersonCode(this IIdentity identity)
        {
            return identity?.GetUserClaimValue("PersonCode");
        }

        public static string GetOrganArea(this IIdentity identity)
        {
            return identity?.GetUserClaimValue("OrganAreaName");
        }

        public static string GetBranchId(this IIdentity identity)
        {
            return identity?.GetUserClaimValue("BranchID");
        }
    }
}