...
using System;
using QtasHelpDesk.DataLayer.Mappings;
using Microsoft.EntityFrameworkCore.Infrastructure;
using QtasHelpDesk.CrossCutting.GuardToolkit;
using QtasHelpDesk.CrossCutting.PersianToolkit;
...
namespace QtasHelpDesk.DataLayer.Context
{
    /// <summary>
        ...
        IUnitOfWork
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.AddGalleryMapping();
            builder.AddContentMapping();
