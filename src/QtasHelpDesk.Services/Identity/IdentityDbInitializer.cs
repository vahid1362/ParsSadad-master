...
{
    /// <summary> More info: http://www.dotnettips.info/post/2577 And http://www.dotnettips.info/post/2578 </summary>
    public class IdentityDbInitializer : IIdentityDbInitializer
    {
        ...
        /// <summary> Applies any pending migrations for the context to the database. Will create the database if it does not already exist. </summary>
        ...
        /// <summary> Adds some default values to the IdentityDb </summary>
