...
using QtasHelpDesk.Areas.Admin;
...
namespace QtasHelpDesk.Areas.Identity.Controllers
{
    [Authorize]
    ...
    public class UserProfileController : Controller
    {
        ...
        private static void updateUserBirthDate(UserProfileViewModel model, Domain.Identity.User user)
        {
